        ...
        <div id="social" style={{background:"black"}}>
            ...
            <Row style={{margin:'0px'}}>
                <Col sm={12} md={12} lg={12} style={{color:"white",backgroundColor:"black"}}>
                    <h1 className="headers" style={{backgroundColor:"black",color:"white",paddingBottom:"60px"}}>Social Initiatives</h1>
               </Col>
            </Row>
            <Row style={{margin:'0px'}}>
                    <Col sm={12} md={5}  style={{color:'white'}}>
                        <Row className="care-padding" style={{margin:'0px'}}>
                            <Col style={{textAlign:"center"}}>
                                <h4 className="spe-size">SPE Cares</h4>
                            </Col>
                        </Row>
                        <Row className="care-padding"  style={{margin:'0px'}}>
                            <Col>
                                <p className="social-text">SPE AUACT Student Chapter is socially
                     ...
                     <Col className="vertical-padding" md={1}>
                        <div className="vertical-line"/>
                    </Col>
                    <Col sm={12} md={5} style={{color:'white'}}>
                        <Row  style={{margin:'0px'}}>
                            <Col style={{textAlign:"center"}}>
                                <h4 className="spe-size">SPE Green Campaign</h4>
                            </Col>
                        </Row>
                        <Row  style={{margin:'0px'}}>
                            <Col>
                                <p className="social-text">SPE AUACT Student Chapter feels glad to
